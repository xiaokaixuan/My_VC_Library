...
public:
	...
	BOOL  GetKeyStruct(LPCTSTR lpAppName, LPCTSTR lpKeyName, LPVOID lpStruct, UINT uSize);
	BOOL  WriteKeyStruct(LPCTSTR lpAppName, LPCTSTR lpKeyName, LPVOID lpStruct, UINT uSize);
	BOOL  GetStringArray(LPCTSTR lpAppName, StringArray& arrayString);
	BOOL  WriteStringArray(LPCTSTR lpAppName, StringArray& arrayString);
